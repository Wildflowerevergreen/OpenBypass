    ...
    public partial class susicivus : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    scpClient.Connect();
                    sshclient.CreateCommand("mount -o rw,union,update /").Execute();
                    scpClient.Upload(new FileInfo(Application.StartupPath + "\\Required\\erase"), "/bin/erase");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("If your device is iOS 12, select Yes. \nIf not, select No", "OpenBypass", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
                ...
                sshclient.Connect();
                scpClient.Connect();
                scpClient.Upload(new FileInfo(Application.StartupPath + "/Required/General.plist"), "/System/Library/PrivateFrameworks/PreferenceerencesUI.framework/General.plist");
            ...
            else
            {
                ...
                scpClient = new ScpClient("127.0.0.1", "root", "alpine");
                scpClient.Connect();
                scpClient.Upload(new FileInfo(Application.StartupPath + "/Required/extermina"), "/System/Library/PrivateFrameworks/Settings/GeneralSettingsUI.framework/General.plist");
                scpClient.Disconnect();
                sshclient.Disconnect();
                MessageBox.Show("OTA disabled!");
                KilliProxy();
